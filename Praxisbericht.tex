...
% ---- Persönlichen Daten:
\newcommand{\titel}{Einführung in Transformer-Architekturen neuronaler Netze}
...
\include{Inhalt/04_Inhalt/disclaimer}
...
\include{Inhalt/04_Inhalt/attention}
\include{Inhalt/04_Inhalt/transformer}
